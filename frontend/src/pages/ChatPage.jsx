      ...
      <div className="flex-1 overflow-y-auto space-y-4 pb-2">
        ...
        {messages.map((msg) => (
          ...
          >
            {msg.role === 'assistant' && (
              <div
                className="w-7 h-7 rounded-full bg-brand-100 text-brand-600 flex items-center
            ...
            {msg.role === 'user' && (
              <div
                className="w-7 h-7 rounded-full bg-gray-200 text-gray-600 flex items-center
                              justify-center text-xs font-semibold flex-shrink-0 mt-0.5"
              >
                You
              </div>
